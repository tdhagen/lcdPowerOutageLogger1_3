 ...
 * T Hagen 21Jan2013 v1.1 - sunrise/sunset added                        *
 * T Hagen 16Oct2014 v1.2 - corrected leading 0 on sunset.              *
 *   Binary sketch size: 22,366 bytes                                   *
 * T Hagen 09Mar2018 v1.3 - Chg sunrise/set display times to 3 seconds  *
 *   Changed location to Davison.  rise/set is now updated to current   *
